...
import foo.fd.estudodecasoincluir.UTILS.GetAPIs;
...
public class MainActivity extends AppCompatActivity {
    ...
    public class ListarEstadosAsyncTask
        ...
        final String URL_WEB_SERVICES = api.getListarEstado();
    ...
    public class ListarCidadesAsyncTask
        ...
        final String URL_WEB_SERVICES = api.getListarCidade();
    ...
    public class DeletarCidadeAsyncTask
        ...
        final String URL_WEB_SERVICES = api.getDeleteCidade();
        ...
        protected void onPostExecute(String result) { // Objeto Json
            ...
            try {
                ...
                if (jsonObject.getBoolean("deletado")) {
                    ...
                    Toast.makeText(MainActivity.this, "Registro" + idCidade+" deletado com Sucesso", Toast.LENGTH_SHORT).show();
    ...
    public class AlterarCidadeAsyncTask
        ...
        final String URL_WEB_SERVICES = api.getALterarCidade();
